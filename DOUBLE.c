...
double * insertD(double * set, int size, double element) {
        double * new_set = realloc(set, size);
...
void mainframeD(void) {
        ...
        a = get_integer();
        double * first = malloc(a * sizeof(double));
        while (key == 0) {
                key = 1;
        ...
        b = get_integer();
        double * second = malloc(b * sizeof(double));
        while (key == 0) {
                key = 1;
        ...
        do {
                ...
                if (set == 1) {
                        ...
                        case 1:
                                ...
                                element = get_double();
                                if (IND(element, first, a)) {
                                        a++;
                                        first = insertD(first, a, element);
                                } else {
                                        printf("Данное множествое уже содержит элемент %lg\n", element);
                                }
                                break;
                        case 2:
                                ...
                                element = get_double();
                                if (!(IND(element, first, a))) {
                                        deletetD(first, a, element);
                                        a--;
                                        first = realloc(first, a);
                                } else {
                                        printf("Данное множество не содержит элемент %lg\n", element);
                                }
                                break;
                        case 3:
                                showD(first, a);
                        ...
                        case 1:
                                printf("Пожалуйста введите элемент который вы хотите добавить в множество: \n");
                                element = get_double();
                                if (IND(element, second, b)) {
                                        b++;
                                        second = insertD(second, b, element);
                                } else {
                                        printf("Данное множествое уже содержит элемент %lg\n", element);
                                }
                                break;
