...
void insertC(char set[],int size, char element){
    set[size-1] = element;
}
...
void mainframeC(void){
    ...
    for (int i = 0; i < b; i++){
        ...
        char num;
        scanf(" %c", &num);
        if (INC(num, second, b) == 1){second[i] = num;}
        else{printf("Такой элемен уже был введен. Пожалуйста вводите уникальные элементы\n"); key = 0; resetC(second, b);break;};
    }
    };
        ...
        if (set == 1){
            ...
            switch( command )
            {
                case 1:
                    ...
                    scanf(" %c", &element);
                    if (INC(element, first, a)){a++;insertC(first, a, element);} else {printf("Данное множествое уже содержит элемент %c\n",element);}
                    break;
                case 2:
                    printf("Пожалуйста введите элемент который вы хотите удалить из множества: \n");
                    scanf(" %c", &element);
                    if (!(INC(element, first, a))){deletetC(first, a, element);a--;}else{printf("Данное множество не содержит элемент %c\n", element);}
                    break;
                case 3: 
                    showC(first, a); 
                    break;
            ...
            switch( command )
            {
                case 1:
                    printf("Пожалуйста введите элемент который вы хотите добавить в множество: \n");
                    scanf(" %c", &element);
                    if (INC(element, second, b)){b++;insertC(second, b, element);}else{printf("Данное множествое уже содержит элемент %c\n",element);}
                    break;
                case 2:
                    printf("Пожалуйста введите элемент который вы хотите удалить из множества: \n");
                    scanf(" %c", &element);
                    if (!(INC(element, second, b))){deletetC(second, b, element);b--;}else{printf("Данное множество не содержит элемент %c\n", element);}
                    break;
                case 3: 
                    showC(second, b); 
                    break;
